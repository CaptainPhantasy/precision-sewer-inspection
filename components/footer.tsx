    ...
    <footer className="bg-primary-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              <div>
                <span className="font-heading font-bold text-white text-lg">Precision</span>
                <span className="block text-xs text-primary-300 -mt-1">Sewer Inspection</span>
              </div>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services" className="text-primary-200 hover:text-white transition-colors text-sm">
              ...
              <li>
                <Link href="/pricing" className="text-primary-200 hover:text-white transition-colors text-sm">
                  Pricing
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/resources" className="text-primary-200 hover:text-white transition-colors text-sm">
                  Resources & Blog
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/status" className="text-primary-200 hover:text-white transition-colors text-sm">
                  Track Your Inspection
                </Link>
              </li>
              <li>
                <Link href="/support" className="text-primary-200 hover:text-white transition-colors text-sm">
                  Support & Terms
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-primary-200 hover:text-white transition-colors text-sm">
                  Privacy Policy
                </Link>
              </li>
            </ul>
          ...
          <div className="lg:col-span-1 lg:min-w-[280px]">
            <h4 className="font-heading font-bold text-lg mb-4 pl-6">Contact Us</h4>
            <ul className="space-y-3">
              ...
              <li>
                ...
                >
                  ...
                  <span>{COMPANY_INFO?.serviceAreaDisplay ?? 'Indianapolis Metro & Surrounding Areas'}</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-10 pt-8 border-t border-primary-800">
          <h4 className="font-heading font-bold text-sm mb-3">Serving Central Indiana</h4>
          <div className="flex flex-wrap gap-2">
            {(SERVICE_AREAS ?? [])?.slice(0, 10)?.map((area) => (
              <span key={area ?? ''} className="text-xs text-primary-300 bg-primary-800 px-2 py-1 rounded">
                {area ?? ''}
              </span>
            ))}
